...
export const EditarPerfil = ({ numArticulos, setMenu }) => {
    ...
    function getCompras() {
        axios.post(URLServer + "getCompras", { "idUsuario": 1 }).then((response) => {
    ...
    return (
        <>
            <div className="cardPerfil contenedorCarrito" >
                <div className="PrimeraSeccion text-center"  >
                    <div style={{"height":"100%","overflowX": "auto" }}>
                        <div className="marginPerfil">
                            ...
                            <div className="text-start marginPerfil">
                                ...
                                <button style={{ "float": "right" }} className="btn btn-dark" onClick={Mapa}>Ver MAPA</button>
                            </div>
                    ...
                    <div className="marginPerfil">
                        ...
                        <div style={{ "display": "grid", "gridTemplateColumns": "50% 50%" }}>
                            ...
                            <div className=" text-center">
                                ...
                                <h4 className="fw-bold text-success TotalesFont  ">{elementsCarrito}</h4>
                            </div>
                            <div className=" text-center">
                                <h6 className='datosPerfil'>Carrito:</h6>
                                <h4 className=" fw-bold text-success TotalesFont">{numArticulos}</h4>
